...
type ImgHashBase interface {
	Compare(a, b cv_lite.Mat) float64
	Compute(inputArr cv_lite.Mat, outputArr *cv_lite.Mat)
}
...
func (hash PHash) Compute(input cv_lite.Mat, output *cv_lite.Mat) {
...
func (hash PHash) Compare(a, b cv_lite.Mat) float64 {
...
// For further information, see:
// https://docs.opencv.org/master/de/d29/classcv_1_1img__hash_1_1ImgHashBase.html#ae2d9288db370089dfd8aab85d5e0b0f3
func (hash AverageHash) Compute(input cv_lite.Mat, output *cv_lite.Mat) {
...
// For further information, see:
// https://docs.opencv.org/master/de/d29/classcv_1_1img__hash_1_1ImgHashBase.html#a444a3e9ec792cf029385809393f84ad5
func (hash AverageHash) Compare(a, b cv_lite.Mat) float64 {
...
// For further information, see:
// https://docs.opencv.org/master/de/d29/classcv_1_1img__hash_1_1ImgHashBase.html#ae2d9288db370089dfd8aab85d5e0b0f3
func (hash BlockMeanHash) Compute(input cv_lite.Mat, output *cv_lite.Mat) {
...
// For further information, see:
// https://docs.opencv.org/master/de/d29/classcv_1_1img__hash_1_1ImgHashBase.html#a444a3e9ec792cf029385809393f84ad5
func (hash BlockMeanHash) Compare(a, b cv_lite.Mat) float64 {
...
// For further information, see:
// https://docs.opencv.org/master/de/d29/classcv_1_1img__hash_1_1ImgHashBase.html#ae2d9288db370089dfd8aab85d5e0b0f3
func (hash ColorMomentHash) Compute(input cv_lite.Mat, output *cv_lite.Mat) {
...
// For further information, see:
// https://docs.opencv.org/master/de/d29/classcv_1_1img__hash_1_1ImgHashBase.html#a444a3e9ec792cf029385809393f84ad5
func (hash ColorMomentHash) Compare(a, b cv_lite.Mat) float64 {
...
// For further information, see:
// https://docs.opencv.org/master/de/d29/classcv_1_1img__hash_1_1ImgHashBase.html#ae2d9288db370089dfd8aab85d5e0b0f3
func (hash MarrHildrethHash) Compute(input cv_lite.Mat, output *cv_lite.Mat) {
...
// For further information, see:
// https://docs.opencv.org/master/de/d29/classcv_1_1img__hash_1_1ImgHashBase.html#a444a3e9ec792cf029385809393f84ad5
func (hash MarrHildrethHash) Compare(a, b cv_lite.Mat) float64 {
...
// For further information, see:
// https://docs.opencv.org/master/de/d29/classcv_1_1img__hash_1_1ImgHashBase.html#ae2d9288db370089dfd8aab85d5e0b0f3
func (hash RadialVarianceHash) Compute(input cv_lite.Mat, output *cv_lite.Mat) {
...
// For further information, see:
// https://docs.opencv.org/master/de/d29/classcv_1_1img__hash_1_1ImgHashBase.html#a444a3e9ec792cf029385809393f84ad5
func (hash RadialVarianceHash) Compare(a, b cv_lite.Mat) float64 {
